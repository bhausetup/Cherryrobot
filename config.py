...
class Config(object):
    log = True
    APP_ID = getenv("API_ID", "26561490")
    API_HASH = getenv("API_HASH", "1cf95f489c37be14568c94a8d09916b8")
    TOKEN = getenv("TOKEN", "")
    ...
    ALLOW_EXCL = True
    CUSTOM_CMD = False
    CHANNEL = getenv("CHANNEL", "ITSBOTS")
    SUPPORT = getenv("SUPPORT", "AdulT_R00M")
    START_IMG = os.environ.get("START_IMG", "https://graph.org/file/7c1dffc198eef66eaf21f.jpg")
    CMD_IMG = os.environ.get("CMD_IMG", "https://graph.org/file/7c1dffc198eef66eaf21f.jpg")
    ...
    CHERRY_USER = list(map(int, getenv("DEV_USERS", "1669178360").split()))
